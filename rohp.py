...
def diagnostico():
    ...
    with st.form('ROHP'):
        ...
        with c2:
            praticas_integracao = st.radio('',[1,2,3,4,5], index=3, horizontal=True)
        ...
        with c2:
            integracao_setores = st.radio('',[1,2,3,4,5], index=3, horizontal=True)
        ...
        with c2:
            programa_integracao = st.radio('',[1,2,3,4,5], index=3, horizontal=True)
