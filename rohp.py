...
def organizacional():
    ...
    with st.form('ROHP'):
        ...
        with c2:
            st.session_state['ambiente_propicio'] = st.radio('',(1,2,3,4,5), key='ambiente_propicio', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['infraestrutura'] = st.radio('',[1,2,3,4,5], key='infraestrutura', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['lideranca'] = st.radio('',[1,2,3,4,5], key='lideranca', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['estrutura_comunicacao'] = st.radio('',[1,2,3,4,5], key='estrutura_comunicacao', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['design'] = st.radio('',[1,2,3,4,5], key='design', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['alinhamento'] = st.radio('',[1,2,3,4,5], key='alinhamento', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['normas'] = st.radio('',[1,2,3,4,5], key='normas', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['estrutura'] = st.radio('',[1,2,3,4,5], key='estrutura', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2,c3=st.columns([1,10,1])
        with c1:
            voltar = st.form_submit_button('Voltar')
...
def humana():
    ...
    with st.form('ROHP'):
        ...
        with c2:
            st.session_state['educacao'] = st.radio('',(1,2,3,4,5), key='educacao', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['treinamento'] = st.radio('',[1,2,3,4,5], key='treinamento', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['perfil'] = st.radio('',[1,2,3,4,5], key='perfil', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['formacao'] = st.radio('',[1,2,3,4,5], key='formacao', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['programa'] = st.radio('',[1,2,3,4,5], key='programa', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['preocupacao'] = st.radio('',[1,2,3,4,5], key='preocupacao', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['estimulos'] = st.radio('',[1,2,3,4,5], key='estimulos', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['incentivo'] = st.radio('',[1,2,3,4,5], key='incentivo', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2,c3=st.columns([1,10,1])
        with c1:
            voltar = st.form_submit_button('Voltar')
...
def processual():
    ...
    with st.form('ROHP'):
        ...
        with c2:
            st.session_state['sistematizacao'] = st.radio('',(1,2,3,4,5), key='sistematizacao', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['praticas_competencia'] = st.radio('',[1,2,3,4,5], key='praticas_competencia', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['processo_codificacao'] = st.radio('',[1,2,3,4,5], key='processo_codificacao', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['conhecimento'] = st.radio('',[1,2,3,4,5], key='conhecimento', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['programa_competencia'] = st.radio('',[1,2,3,4,5], key='programa_competencia', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['tic'] = st.radio('',[1,2,3,4,5], key='tic', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['gestao_doc'] = st.radio('',[1,2,3,4,5], key='gestao_doc', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2 = st.columns([6,2])
        with c1:
        ...
        with c2:
            st.session_state['mapeamento'] = st.radio('',[1,2,3,4,5], key='mapeamento', horizontal=True)
        st.markdown('<hr>', unsafe_allow_html=True)
        c1,c2,c3=st.columns([1,10,1])
        with c1:
            voltar = st.form_submit_button('Voltar')
